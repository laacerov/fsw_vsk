...
am__append_1 = --frames
am__append_2 = lcov lcov-report lcov-rerun clean-lcov covcheck uncovered
subdir = .
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/m4/libtool.m4 \
	$(top_srcdir)/m4/ltoptions.m4 $(top_srcdir)/m4/ltsugar.m4 \
	$(top_srcdir)/m4/ltversion.m4 $(top_srcdir)/m4/lt~obsolete.m4 \
	$(top_srcdir)/acinclude.m4 $(top_srcdir)/m4/sac-pkg-config.m4 \
	$(top_srcdir)/m4/sac-general.m4 \
	$(top_srcdir)/m4/sac-openssl.m4 $(top_srcdir)/m4/sac-su2.m4 \
	$(top_srcdir)/m4/sac-su.m4 $(top_srcdir)/m4/sac-tport.m4 \
	$(top_srcdir)/m4/sac-coverage.m4 $(top_srcdir)/configure.ac
...
am__DIST_COMMON = $(dist_man_MANS) $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/rules/lcov.am AUTHORS COPYING ChangeLog README \
...
ACLOCAL = ${SHELL} /usr/local/src/sofia-sip/missing aclocal-1.16
ACLOCAL_AMFLAGS = -I m4
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /usr/local/src/sofia-sip/missing autoconf
AUTOHEADER = ${SHELL} /usr/local/src/sofia-sip/missing autoheader
AUTOMAKE = ${SHELL} /usr/local/src/sofia-sip/missing automake-1.16
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /usr/local/src/sofia-sip/missing makeinfo
MANIFEST_TOOL = :
MINGW_ENVIRONMENT = 
...
PACKAGE_STRING = sofia-sip 1.13.9
...
abs_builddir = /usr/local/src/sofia-sip
abs_srcdir = /usr/local/src/sofia-sip
abs_top_builddir = /usr/local/src/sofia-sip
abs_top_srcdir = /usr/local/src/sofia-sip
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/local/src/sofia-sip/install-sh
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/rules/lcov.am $(am__configure_deps)
	@for dep in $?; do \
...
$(top_srcdir)/rules/lcov.am $(am__empty):
...
libsofia-sip-ua/su/sofia-sip/su_configure.h: libsofia-sip-ua/su/sofia-sip/stamp-h2
	@test -f $@ || rm -f libsofia-sip-ua/su/sofia-sip/stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) libsofia-sip-ua/su/sofia-sip/stamp-h2
